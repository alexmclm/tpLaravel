...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2019 a las 17:21:24
...
CREATE TABLE `nivelurgencia` (
  ...
  `tipoUrgencia` varchar(200) NOT NULL,
...
ALTER TABLE `cliente`
  ADD PRIMARY KEY (`id`),
  ADD KEY `urgencia_fk` (`nivelUrgencia_id`);
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `urgencia_fk` FOREIGN KEY (`nivelUrgencia_id`) REFERENCES `nivelurgencia` (`id`);
COMMIT;
